...
from calculations_functions import calc_mean, calc_sdv, calc_mode, calc_min, calc_max, calc_median, calc_sdv
...
def test_calc_mode():
    ...
    assert calc_mode([1,2,3]) == [1,2,3]
    assert calc_mode([6,6,6,6,1,3,3,3,3,4,5,5]) == [6,3]
